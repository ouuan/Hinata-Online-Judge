...
Route::group(
	...
	function () {
		...
		Route::any('/ranklist', '/ranklist.php');
		Route::any('/acrank', '/acrank.php');
		...
		Route::any('/problem/{id}/tutorial', '/discuss.php?type=tutorial');
		Route::any('/problem/{id}/discuss', '/discuss.php?type=discuss');
	}
);
